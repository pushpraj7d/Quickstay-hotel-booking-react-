    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
       ...
       <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
                <img src={room.hotel.owner.image} alt="Host" className='h-14 invert w-14 md:h-18 md:w-18 rounded-full'/>
                <div>
            ...
            <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-700 hover:bg-blue-600 transition-all cursor-pointer'>Contact Now</button>
       </div>
