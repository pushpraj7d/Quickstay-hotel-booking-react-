...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 mb:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <Title title='My Bookings' subTitle='easily manage your paste, current, and upcoming hotel reservation in one place. Plan your trips seamlessly with just a few clicks' align='left'/>
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            ...
            {bookings.map((booking)=>(
                <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr__1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                    {/* Hotel details */}
